...
const DEFAULT_TITLE = "The New Sundai | AI for Business Leaders, Every Sunday";
const DEFAULT_DESCRIPTION =
  "The weekly Sunday briefing that gives business leaders a head start on AI. By Remco Vroom, Global EVP MarTech AI Transformation at Monks.";
